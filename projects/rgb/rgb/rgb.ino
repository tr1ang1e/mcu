 ...
 *      два регистра соответствуют одному таймеру
 *      один таймер распространяется на два пина
...
// таймер 1 (пины 9, 10) - результирующая частота 31.4 кГц
#define T1_A_VALUE   0b00000001
#define T1_B_VALUE   0b00000001

// таймер 2 (пины 3, 11) - результирующая частота 31.4 кГц
